  ...
  const steps = [
    {
      ...
      description:
        "We source the finest, locally-grown ingredients to ensure the highest quality and flavor in every bite.",
      imgSrc: "/assets/images/freshIngredients.jpg",
    },
    {
      title: "Old Recipes",
      description:
        "Our time-honored recipes have been perfected over generations, preserving authentic flavors and techniques.",
      imgSrc: "/assets/images/oldRecipes.jpg",
    },
    {
      title: "Quality Check",
      description:
        "Each product undergoes rigorous quality control to meet our exacting standards before reaching our customers.",
      imgSrc: "/assets/images/qualityCheck.jpg",
    },
    {
      title: "Sweet Result",
      description:
        "The final product is a delightful treat that combines tradition, quality, and irresistible taste.",
